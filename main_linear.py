...
from training_linear.training_one_epoch_ckpt_bce_unlock_layer4 import main_bce_unlock_layer4
...
if __name__ == '__main__':
    ...
    # opt.super --> (4) 解锁特征提取器的最后一层

    if(opt.super==1 and opt.multi ==0 ):

        main_supervised()
    elif (opt.super == 4 and opt.multi == 0):

        main_bce_unlock_layer4()
