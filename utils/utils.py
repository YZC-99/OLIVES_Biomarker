...
from datasets.biomarker import BiomarkerDatasetAttributes, BiomarkerDatasetAll
...
def set_loader_new(opt):
    ...
    if opt.dataset =='OCT':
        ...
        data_path_train = "/home/gu721/yzc/data/ophthalmic_multimodal/OLIVES"
        csv_path_train = "/home/gu721/yzc/OLIVES_Biomarker/data/train_dataset.csv"
        csv_path_test = "/home/gu721/yzc/OLIVES_Biomarker/data/val_dataset.csv"
        ...
        if(opt.super == 2 and opt.multi == 0):
            ...
            train_dataset = BiomarkerDatasetAll(csv_path_train, data_path_train, transforms=train_transform)
            test_dataset = BiomarkerDatasetAll(csv_path_test, data_path_test, transforms=val_transform)
        else:
            train_dataset = BiomarkerDatasetAttributes(csv_path_train,data_path_train,transforms = train_transform)
            test_dataset = BiomarkerDatasetAttributes(csv_path_test,data_path_train,transforms = val_transform)
    else:
