...
import torch
from models.resnet import SupConResNet,SupConResNet3Channels
from models.vit import SupConVit
...
def set_model_contrast(opt):
    ...
    if opt.model in ['resnet18', 'resnet50']:
        model = SupConResNet3Channels(name=opt.model)
    elif opt.model in ['vit_small_patch16_224', 'vit_base_patch16_224']:
...
def set_loader(opt):
    ...
    if opt.dataset =='OCT':
        ...
        csv_path_train = "/home/gu721/yzc/data/ophthalmic_multimodal/OLIVES_Dataset_Labels/ml_centric_labels/Clinical_Data_Images.xlsx"
        # data_path_train = opt.train_image_path
